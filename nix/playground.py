...
BULK_FAST5_FILE = f"{PROJECT_DIR_LOCATION}/tests/data/bulk_fast5_dummy.fast5"
CAPTURE_FAST5_FILE = f"{PROJECT_DIR_LOCATION}/tests/data/reads_fast5_dummy_9captures.fast5"
CLASSIFIED_FAST5_FILE = f"{PROJECT_DIR_LOCATION}/tests/data/classified_9captures.fast5"
CLASSIFIER_DETAILS_FAST5_FILE = f"{PROJECT_DIR_LOCATION}/tests/data/classifier_details_test.fast5"
CLASSIFIED_10_MINS_4_CHANNELS = f"{PROJECT_DIR_LOCATION}/tests/data/classified_10mins_4channels.fast5"
FILTER_FAST5_FILE = f"{PROJECT_DIR_LOCATION}/tests/data/filter_and_store_result_test.fast5"
