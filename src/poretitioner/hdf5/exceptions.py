...
class HDF5_GroupSerializationException(HDF5_SerializationException):
    ...
    def __init__(self, msg: str, *args: object, group: Optional[h5py.Group] = None) -> None:
...
class HDF5_DatasetSerializationException(HDF5_SerializationException):
    ...
    def __init__(self, msg: str, *args: object, dataset: Optional[h5py.Dataset] = None) -> None:
        super().__init__(msg, *args)
