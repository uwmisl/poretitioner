...
from typing import Any, Dict, Generic, Iterable, Mapping, Optional, Protocol, Type, TypeVar, TypedDict, Union

from abc import abstractmethod, ABC
from logging import getLogger, Logger

from .exceptions import HDF5_SerializationException, HDF5_GroupSerializationException
...
class HDF5_AttributeHaving(HasAttrs):
    ...
    def objects_from_attrs(self, log: Optional[Logger] = None) -> HDF5_Attribute_Objects:
        objects: HDF5_Attribute_Objects = { attr_name: self.object_from_attr(attr_name, log=log) 
...
class HDF5_GroupSerializable(HDF5_GroupSerializing):
    ...
    def require_group_from_group(self, parent_group: HDF5_Group, log: Optional[Logger] = None) -> HDF5_GroupSerializable:
