...
# TODO: Restore classification unit tests: https://github.com/uwmisl/poretitioner/issues/92
...
#     f5_fname = "src/tests/data/reads_fast5_dummy_9captures.fast5"
...
#     # Copy sample file
#     orig_f5_fname = "src/tests/data/classifier_details_test.fast5"
...
#     f5_fname = "src/tests/data/classified_9captures.fast5"
...
#     # Prepare file for testing
#     orig_f5_fname = "src/tests/data/filter_and_store_result_test.fast5"
